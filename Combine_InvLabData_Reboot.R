...
UniqueSitesList_2017 <- read.csv("UniqueSitesList_2017.csv", header = TRUE, stringsAsFactors = F)
...
# hand <- read.csv("//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/DB_Ingest/INVLab_Combined_Update.csv", header = TRUE)
