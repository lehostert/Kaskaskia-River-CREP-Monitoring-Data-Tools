...
INVLab_2017 <- read.csv("//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/INV_Lab/EcoAnalysts_MacroinvertebrateTaxonomy_2014-2017_reconcile_names.csv", header = TRUE)
names(INVLab_2017)
...
INVLab_2013 <- read.csv("//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/INV_Lab/EcoAnalysts_MacroinvertebrateTaxonomy_2013-2014_reconcile_names.csv", header = TRUE, na = ".")
names(INVLab_2013)
...
write.csv(INVLab_Combined, file= "//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/DB_Ingest/INVLab_Combined_blank_lifestage.csv", na = "")
