...
catchment_features <- read_csv("Site_Selection/Data/Kaskaskia_Catchment_Sizes_and_Features.csv")
year <- 2019
...
write.csv(LD_sites_W_and_WT, file = paste0("C:/Users/lhostert/Documents/CREP/R_Scripts/Sites/", year,"_LD_AllSites.csv"), row.names = F)
LD_All_Sites <- LD_sites_W_and_WT %>% select(PU_Gap_Code, W_LU_Disturbed, W_LU_Undisturbed, WT_LU_Disturbed, WT_LU_Undisturbed, W_Undisturbed_Level, WT_Undisturbed_Level) %>% left_join(catchment_features, by = 'PU_Gap_Code')write.csv(LD_sites_W_and_WT, file = paste0("C:/Users/lhostert/Documents/CREP/R_Scripts/Sites/", year,"_LD_AllSites.csv"), row.names = F)
LD_All_Sites <- LD_sites_W_and_WT %>% select(PU_Gap_Code, W_LU_Disturbed, W_LU_Undisturbed, WT_LU_Disturbed, WT_LU_Undisturbed, W_Undisturbed_Level, WT_Undisturbed_Level) %>% left_join(catchment_features, by = 'PU_Gap_Code')
write.csv(LD_All_Sites, file = paste0("C:/Users/lhostert/Documents/CREP/R_Scripts/Sites/", year,"_LD_AllSites.csv"), row.names = F)