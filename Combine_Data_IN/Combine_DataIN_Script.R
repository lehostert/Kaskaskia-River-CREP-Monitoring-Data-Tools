...
### Discharge
DSC_filenames <- list.files(path="//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/DSC", pattern="2019(.*)\\.csv$")
...
DSC_dataset <- DSC_fulldataset %>% 
  select(-c(Event_Year,Event_Month, Event_Day)) %>% 
  # stringr::str_replace_all("\\.", replacement = NA_character_)
  naniar::replace_with_na_all(condition =  ~.x == ".")
stringr::str_replace(DSC_dataset$Reach_Name, "kasky[:blank:]|Kasky[:blank:]","kasky")
...
### Fish Metadata 
 FMD_filenames <- list.files(path="//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/FMD", pattern="*.csv")
 ...
 write.csv(FMD_dataset, file= "//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/DB_Ingest/FMD_2018.csv", na=".")
...
FSH_fullpath=file.path("//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/FSH",FSH_filenames)
 ...
 FLW_filenames <- list.files(path="//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/FLW", pattern="*.csv")
...
IHI_filenames <- list.files(path="//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/IHI", pattern="*.csv")
 ...
 write.csv(IHI_dataset, file= "//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/DB_Ingest/IHI_2018.csv")
...
INV_filenames <- list.files(path="//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/INV", pattern="*.csv")
  ...
  write.csv(INV_dataset, file= "//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/DB_Ingest/INV_2018.csv")
  

## Qualitative Habitat Evaluation Index
  
  QHEI_filenames <- list.files(path="//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/QHEI", pattern="*.csv")
  ...
  write.csv(QHEI_dataset, file= "//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/DB_Ingest/QHEI_2018.csv")
  
  
### Stream Water Chemistry
  
  SWC_filenames <- list.files(path="//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/SWC", pattern="*.csv")
  ...
  write.csv(SWC_dataset, file= "//INHS-Bison/ResearchData/Groups/Kaskaskia_CREP/Data/Data_IN/DB_Ingest/SWC_2018.csv")
