...
# RPMC_file_path <- "C:/Users/lhostert/Documents/GitHub/Kaskaskia-River-CREP-Monitoring-Data-Tools/CREP_Invert_Species_Matrix_LEH_RPMC_test.csv"
# 
# RPMC <- tibble::as_tibble(read.csv(RPMC_file_path, header = T, na = c("NA",".")))
...
output_file_path = "CREP_Invert_Species_Matrix_AdultPupae.csv"
