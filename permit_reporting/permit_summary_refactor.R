...
fish$Release_status <- str_replace(fish$Release_status, "mortality", "Destroyed")
...
permit <- fish_check %>% 
  ...
  select(Fish_Species_Common, Latitude, Longitude, Observation_Date = Fish_Date, Abundance = Fish_Species_Count, 
